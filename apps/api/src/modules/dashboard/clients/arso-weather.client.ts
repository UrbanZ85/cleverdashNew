...
// research.md §3. Oblika preverjena neposredno proti živemu odgovoru 19. 8. 2026:
...
//
// `.passthrough()` povsod: berejo se samo polja, ki jih FR-023/FR-024 zahtevata; sprememba
// v neuporabljenem delu odgovora ne sme podreti ploščice. Sprememba v UPORABLJENEM delu pa
// zavrne `.parse()` in sproži pot "spremenjena struktura" iz research.md §13.
 ...
 * (research.md §3), zato pogojnih glav ni — vsaka osvežitev je poln prenos. */
